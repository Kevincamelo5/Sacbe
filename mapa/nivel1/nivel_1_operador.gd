...
@export var _contenedor_botones: GridContainer
@export var _campo_respuesta: LineEdit
@export var _campo_operandos: Label
@export var _boton_enviar: Button

var _operador:= '+'
var _operandos: Array = []
...
func _generar_problema() -> bool:
	...
	_operador = OPERADORES[randi_range(0, OPERADORES.length() - 1)]
	
	_operandos = []
	
	var respuesta := 0.0 if _operador in "+-" else 1.0
	for i in 2:
