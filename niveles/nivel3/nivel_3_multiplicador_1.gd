...
# MODIFICADO: Se rediseñó esta función para albergar multiplicaciones directas
func _generar_problema() -> bool:
	...
	# Multiplicamos directamente un número por el otro
	var respuesta : int = num1 * num2
